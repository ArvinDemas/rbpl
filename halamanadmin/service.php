...
<section class="min-h-screen ml-[256px] p-4 md:p-8 lg:p-12 bg-[#FAFAFA]">
  ...
  <h1 class="text-black text-3xl font-semibold mt-8">Service Progres</h1>

  <div class="mt-6 w-full max-w-6xl mx-auto bg-white rounded-xl p-6 shadow-md">
    <div class="flex justify-between items-center mb-4">
      <p class="text-[#27272A] text-lg font-medium">25 - 02 - 2023</p>
      <p class="text-[#4763E4] text-base font-normal">02 pays</p>
    </div>
    <div class="flex items-center gap-4 mb-6">
      <input type="text" placeholder="Vous cherchez un pays ..." class="flex-1 px-4 py-2 border border-[#4763E4]/50 rounded-md text-sm text-[#A1A1AA]" />
    </div>

    <!-- Table Header -->
    <div class="grid grid-cols-8 gap-4 font-medium text-[#A1A1AA] text-sm border-b pb-3 mb-3">
      <span>Queue</span>
    ...
    <div class="flex flex-col gap-4">
      <div class="grid grid-cols-8 gap-4 items-center text-sm text-[#27272A]">
        <span>01</span>
        <span>Basic Maintenance</span>
        <span>Jane Cooper</span>
        <span>08112233445566</span>
        <span>Aerox</span>
        <span>AB 5128 ID</span>
        <span class="text-xs bg-blue-100 rounded-md px-2 py-1">...</span>
        <div class="flex items-center gap-2">
          <span class="text-base border border-[#EBEBEB] px-4 py-2 rounded-md">Order Confirmed</span>
        </div>
      </div>
      <div class="grid grid-cols-8 gap-4 items-center text-sm text-[#27272A]">
        <span>02</span>
        ...
        <span>08112233445566</span>
        <span>Aerox</span>
        <span>AB 5127 II</span>
        <span class="text-xs bg-blue-100 rounded-md px-2 py-1">...</span>
        <div class="flex items-center gap-2">
          <span class="text-base border border-[#EBEBEB] px-4 py-2 rounded-md">Working On</span>
        </div>
      </div>
      <div class="grid grid-cols-8 gap-4 items-center text-sm text-[#27272A]">
        <span>03</span>
